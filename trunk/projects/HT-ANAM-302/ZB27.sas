...
else if ITMDXARSN^='' and ITMDXARSNOTHSPC ^='' then ITMDXAPERF=strip(scan(ITMDXARSN,1,','))||': '||strip(ITMDXARSNOTHSPC);
else if ITMDXARSN^='' and ITMDXARSNMECHSPC ^='' then ITMDXAPERF=strip(scan(ITMDXARSN,1,','))||': '||strip(ITMDXARSNMECHSPC);
else if ITMDXARSN^='' and ITMDXARSNAENUM ^='' then ITMDXAPERF=strip(scan(ITMDXARSN,1,','))||': '||strip(ITMDXARSNAENUM);
