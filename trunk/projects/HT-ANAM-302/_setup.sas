...
/*%let rawdatadir               =       %str(Q:\WorkSpace\Public\Janus\TJ\D1--WXC\CY\Temp\Raw Data302\Raw Data);*/
%let rawdatadir               =       %str(Q:\Files\C111\HT-ANAM-302\cdisc\dev\data\raw);
%let studyid                  =       %str(HT-ANAM-302);
%let demodset                 =       %str(pdata.dm06);
%let subjectvar               =       %str(subjectnumberstr);
/*%let subset                   =       %str(036-206 034-202 701-228 701-238 704-202 454-285 451-201 457-203 460-209 460-208 901-205 805-201 901-204 704-204 703-207);*/
/*%let subset                   =       %str(457-203 460-209 701-238);*/
/*%let subset                   =       %str(901-203 902-203 036-202 704-203);*/
%let subset                   =       %str(039-202 451-218 454-213 455-209 460-207 460-213 550-205 556-207 701-219 706-204 800-203 802-201 802-202);

%let dlm4subj                 =       %str( );
%let newtransferID            =       %str(28JAN2014);
%let escapechar               =       %str(^);
