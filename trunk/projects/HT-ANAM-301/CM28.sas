...
*<cm28--------------------------------------------------------------------------------------------------------;
%getdy(indata=source.RD_FRMCM_SCTCMENTRY_ACTIVE,outdata=RD_FRMCM_SCTCMENTRY_ACTIVE,vars=ITMCMEND_DTS);
%getdy(indata=RD_FRMCM_SCTCMENTRY_ACTIVE,outdata=RD_FRMCM,vars=ITMCMSTARTDT_DTS);
data cm0;
...
/*	%formatDate(ITMCMEND_DTS); %formatDate1(ITMCMSTARTDT_DTR); */
	%informatDate(DOV);
