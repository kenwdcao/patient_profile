...
data mh0;
	...
	EGFR1=coalescec(ITMMHIHC_CITM0,ITMMHIHC_CITM1PLUS,ITMMHIHC_CITM2PLUS,ITMMHIHC_CITM3PLUS,
					ITMMHIHC_CITMNEGATIVE,ITMMHIHC_CITMPOSITIVE);
	if coalescec(ITMMHMUT_CITMMUTATED,ITMMHMUT_CITMNOTMUTATED,ITMMHMUT_ITMMHMUTOTH)='Other, specify' 
		then EGFR2_='Other Mutation';
