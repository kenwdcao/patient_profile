...
%let rootdir                  =       %str(E:\Local Data\Development\SAS\Projects\Patient Profile);
%let rawdatadir               =       %str(E:\Local Data\Janus\Projects\CDM\ARQ 092-101\arql013_20131001T0031);
%let studyid                  =       %str(HT-ANAM-303);
%let demodset                 =       %str(pdata.dm06);
%let subjectvar               =       %str(subjectnumberstr);
%let subset                   =       %str();
%let dlm4subj                 =       %str( );
%let newtransferID            =       %str(30AUG2013);
%let escapechar               =       %str(!);
