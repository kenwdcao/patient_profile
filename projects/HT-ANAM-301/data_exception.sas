...
/*	%if &nobs^=0 and &dset=LBHEM %then %do;
	...
	%if &nobs^=0 and &dset=LBHEM_P1 %then %do;
		%getVisitLabel;
		*Ken on 213/10/11:;
	/*	%wraplbname;*/
		%end;

	%if &nobs^=0 and &dset=LBHEM_P2 %then %do;
		%getVisitLabel;
		*Ken on 213/10/11:;
	/*	%wraplbname;*/
		%end;
...
/*	%else %if &nobs^=0 and &dset=LBCHEM %then %do;
	...
	%if &nobs^=0 and &dset=LBCHEM_P1 %then %do;
		%getVisitLabel;
		*Ken on 213/10/11:;
	/*	%wraplbname;*/
		%end;

	%if &nobs^=0 and &dset=LBCHEM_P2 %then %do;
		%getVisitLabel;
		*Ken on 213/10/11:;
	/*	%wraplbname;*/
		%end;
	...
	%else %if &nobs^=0 and &dset=LBCHEM25_P1 %then %do;
		%getVisitLabel;
		*Ken on 213/10/11:;
	/*	%wraplbname1;*/
		%end;

	%else %if &nobs^=0 and &dset=LBCHEM25_P2 %then %do;
		%getVisitLabel;
		*Ken on 213/10/11:;
	/*	%wraplbname1;*/
		%end;
